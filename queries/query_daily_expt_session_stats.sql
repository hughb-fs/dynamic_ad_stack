...
select date, bidder,
    if (
                ('2024-08-28' <= date and date < '2024-09-24' and status = 'disabled'
                    and bidder in  ('ix', 'rise', 'appnexus', 'rubicon', 'triplelift', 'pubmatic'))
            or
                ('2024-09-24' <= date and date < '2024-10-08' and status = 'disabled'
                    and bidder in  ('ix', 'rise', 'appnexus', 'rubicon', 'triplelift', 'pubmatic', 'yieldmo', 'sharethrough', 'criteo', 'medianet', 'openx', 'gumgum', 'yahoo', 'yahoossp'))
            or
                ('2024-10-08' <= date and status = 'disabled'
                    and bidder in  ('pubmatic',  'sharethrough', 'criteo',  'ix', 'rise', 'openx', 'rubicon', 'triplelift', 'yieldmo')),
