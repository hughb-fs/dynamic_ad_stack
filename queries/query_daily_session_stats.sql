...
CREATE OR REPLACE TABLE `{project_id}.DAS_increment.daily_session_stats_{processing_date}_{days_back_start}_{days_back_end}`
    OPTIONS (
...
session_agg AS (
    ...
    WHERE
        ...
        fs_testgroup in ('experiment', 'optimised')
